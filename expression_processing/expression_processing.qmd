...
create_expression_umap_raster <- function(sce, expression_subtable, feature, feature_max, centers.umap) {
  ...
  expression_subtable[[feature]] <- pmin(expression_subtable[[str_replace(feature, "-", ".")]], feature_max)
...
for(feature in c("FSC-A", "FSC-H", "SSC-A", "SSC-H", "SSC-B-H", "SSC-B-A", "LIVE-DEAD-Blue-A")) {
  print(create_expression_umap_raster(sce, expression, feature, max(expression[[str_replace(feature, "-", ".")]]), centers.umap_clearing))
}
```
